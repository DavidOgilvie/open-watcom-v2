...
#define SVCID_HOSTNAME \
    { 0x0002A800, 0x0000, 0x0000, { 0xC0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x46 } }
#define SVCID_INET_HOSTADDRBYINETSTRING \
    { 0x0002A801, 0x0000, 0x0000, { 0xC0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x46 } }
#define SVCID_INET_SERVICEBYNAME \
    { 0x0002A802, 0x0000, 0x0000, { 0xC0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x46 } }
#define SVCID_INET_HOSTADDRBYNAME \
    { 0x0002A803, 0x0000, 0x0000, { 0xC0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x46 } }

/* Macros to manipulate service GUIDs */
#define SVCID_TCP_RR( p1, p2 ) \
    { 0x00090000 | p1, 0, p2, { 0xC0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x46 } }
#define SVCID_TCP( x )              SVCID_TCP_RR( x, 0 )
#define SVCID_DNS( x )              SVCID_TCP_RR( 53, x )
#define IS_SVCID_DNS( x ) \
    (((x)->Data1 == 0x00090035) && ((x)->Data2 == 0x0000) && ((x)->Data4[0] == 0xC0) && \
    ((x)->Data4[1] == 0x00) && ((x)->Data4[2] == 0x00) && ((x)->Data4[3] == 0x00) && \
    ((x)->Data4[4] == 0x00) && ((x)->Data4[5] == 0x00) && ((x)->Data4[6] == 0x00) && \
    ((x)->Data4[7] == 0x46))
#define IS_SVCID_TCP( x ) \
    ((((x)->Data1 & 0xFFFF0000) == 0x00090000) && ((x)->Data2 == 0x0000) && \
    ((x)->Data4[0] == 0xC0) && ((x)->Data4[1] == 0x00) && ((x)->Data4[2] == 0x00) && \
    ((x)->Data4[3] == 0x00) && ((x)->Data4[4] == 0x00) && ((x)->Data4[5] == 0x00) && \
    ((x)->Data4[6] == 0x00) && ((x)->Data4[7] == 0x46))
#define PORT_FROM_SVCID_TCP( x ) \
    ((WORD)((x)->Data1 & 0x0000FFFF))
#define RR_FROM_SVCID( x ) \
    ((x)->Data3)
#define SET_TCP_SVCID_RR( x, p1, p2 ) \
    { \
        (x)->Data1 = 0x00090000 | p1; \
        (x)->Data2 = 0x0000; \
        (x)->Data3 = p2; \
        (x)->Data4[0] = 0xC0; \
        (x)->Data4[1] = 0x00; \
...
#define SET_TCP_SVCID( x, p )       SET_TCP_SVCID_RR( x, p, 0 )
#define SVCID_UDP_RR( p1, p2 ) \
    { 0x000A0000 | p1, 0, p2, { 0xC0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x46 } }
#define SVCID_UDP( x )              SVCID_UDP_RR( x, 0 )
#define IS_SVCID_UDP( x ) \
    ((((x)->Data1 & 0xFFFF0000) == 0x000A0000) && ((x)->Data2 = 0x0000) && \
    ((x)->Data4[0] == 0xC0) && ((x)->Data4[1] == 0x00) && ((x)->Data4[2] == 0x00) && \
    ((x)->Data4[3] == 0x00) && ((x)->Data4[4] == 0x00) && ((x)->Data4[5] == 0x00) && \
    ((x)->Data4[6] == 0x00) && ((x)->Data4[7] == 0x46))
#define PORT_FROM_SVCID_UDP( x )    ((WORD)((x)->Data1 & 0x0000FFFF)
#define SET_UDP_SVCID_RR( x, p1, p2 ) \
    { \
        (x)->Data1 = 0x000A0000 | p1; \
        (x)->Data2 = 0x0000; \
        (x)->Data3 = p2; \
        (x)->Data4[0] = 0xC0; \
        (x)->Data4[1] = 0x00; \
...
#define SET_UDP_SVCID( x, p )       SET_UDP_SVCID_RR( x, p, 0 )
#define SVCID_NETWARE( x ) \
    { 0x000B0000 | x, 0x0000, 0x0000, { 0xC0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x46 } }
#define IS_SVCID_NETWARE( x ) \
    ((((x)->Data1 & 0xFFFF0000) == 0x000B0000) && ((x)->Data2 == 0x0000) && \
    ((x)->Data3 == 0x0000) && ((x)->Data4[0] == 0xC0) && ((x)->Data4[1] == 0x00) && \
    ((x)->Data4[2] == 0x00) && ((x)->Data4[3] == 0x00) && ((x)->Data4[4] == 0x00) && \
    ((x)->Data4[5] == 0x00) && ((x)->Data4[6] == 0x00) && ((x)->Data4[7] == 0x46))
#define SAPID_FROM_SVCID_NETWARE( x )   ((WORD)((x)->Data1 & 0x0000FFFF))
#define SET_NETWARE_SVCID( x, p ) \
    { \
        (x)->Data1 = 0x000B0000 | p1; \
        (x)->Data2 = 0x0000; \
        (x)->Data3 = 0x0000; \
        (x)->Data4[0] = 0xC0; \
        (x)->Data4[1] = 0x00; \
...
#define SVCID_NET_RWHO_UDP          SVCID_UDP( 550 )
...
#define SVCID_RSRC3_UDP             SVCID_UDP( 10003 )
...
/* NetWare service identifiers */
#define SVCID_PRINT_QUEUE                   SVCID_NETWARE( 0x0003 )
#define SVCID_FILE_SERVER                   SVCID_NETWARE( 0x0004 )
#define SVCID_JOB_SERVER                    SVCID_NETWARE( 0x0005 )
#define SVCID_GATEWAY                       SVCID_NETWARE( 0x0006 )
#define SVCID_PRINT_SERVER                  SVCID_NETWARE( 0x0007 )
#define SVCID_ARCHIVE_QUEUE                 SVCID_NETWARE( 0x0008 )
#define SVCID_ARCHIVE_SERVER                SVCID_NETWARE( 0x0009 )
#define SVCID_JOB_QUEUE                     SVCID_NETWARE( 0x000A )
#define SVCID_ADMINISTRATION                SVCID_NETWARE( 0x000B )
#define SVCID_NAS_SNA_GATEWAY               SVCID_NETWARE( 0x0021 )
#define SVCID_REMOTE_BRIDGE_SERVER          SVCID_NETWARE( 0x0024 )
#define SVCID_TIME_SYNCHRONIZATION_SERVER   SVCID_NETWARE( 0x002D )
#define SVCID_ARCHIVE_SERVER_DYNAMIC_SAP    SVCID_NETWARE( 0x002E )
#define SVCID_ADVERTISING_PRINT_SERVER      SVCID_NETWARE( 0x0047 )
#define SVCID_BTRIEVE_VAP                   SVCID_NETWARE( 0x004B )
#define SVCID_NETWARE_386                   SVCID_NETWARE( 0x0107 )
#define SVCID_SAA_SERVER                    SVCID_NETWARE( 0x0130 )
#define SVCID_DIRECTORY_SERVER              SVCID_NETWARE( 0x0278 )
#define SVCID_HP_PRINT_SERVER               SVCID_NETWARE( 0x030C )
#define SVCID_SNA_SERVER                    SVCID_NETWARE( 0x0444 )

/* DNS service identifiers */
