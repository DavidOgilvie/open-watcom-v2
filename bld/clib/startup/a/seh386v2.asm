...
;*  ========================================================================
;*
;* Description:  SEH routines with old names. To be removed.
;*
;*****************************************************************************
...
__TryHandler2 proc near export
        ...
        _else                           ; else
          ...
          _loop                         ; - loop (find _except filter => 1)
            ...
            _if   e                     ; - - then
              ...
              ; _except filter code ends with a call to __Except2. See below.
              ; filter may have destroyed some registers on us.
__Except2 proc near export
...
;
;       __Except2 is called from the fragment "} _except( expr ) {"
