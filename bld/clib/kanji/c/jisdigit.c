...
/**
*
*  Name:        jisdigit        全角数字コード
*
*  Synopsis:    ret = jisdigit( c );    (0x824f <= c <= 0x8258)
*
...
*  Name:        jisdigit        Check 2-byte KANJI code of numeric
*
*  Synopsis:    ret = jisdigit( c );    (0x824f <= c <= 0x8258)
*
...
*               numeric. It returns non-zero if true, zero if fault.
*               The range of 2-byte KANJI code set is the below.
*               0x824f <= c <= 0x8258
*
**/

_WCRTLINK int jisdigit( JMOJI c )
{
