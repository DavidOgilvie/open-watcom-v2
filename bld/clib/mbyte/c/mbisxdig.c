...
/**
 * Determine if a multibyte character is a hexadecimal digit.
 */

_WCRTLINK int _ismbcxdigit( unsigned int ch )
{
#ifdef __NT__
    BOOL                rc;
    int                 len;
    ...
    if( (char_type[ 0 ] & C1_XDIGIT) == 0 ) return( 0 );
    return( 1 );
