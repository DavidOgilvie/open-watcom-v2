...
/**
*
*  Name:        jisalpha        全角英文字コード
*
*  Synopsis:    ret = jisalpha( c );    (0x8260 <= c <= 0x8279
*                                       or 0x8281 <= c <= 0x829a)
*
...
*
*
*  Name:        jisalpha        Check 2-byte KANJI code of alphabet
*
*  Synopsis:    ret = jisalpha( c );    (0x8260 <= c <= 0x8279
*                                       or 0x8281 <= c <= 0x829a)
*
