...
#ifndef __GTINHOPT_H__
#define __GTINHOPT_H__
...
class GTInheritOption : public InheritStyleDlg, public GTLineEditor,
                        public WDialog
{
public:
                                GTInheritOption( const GTClassOpts & );
                                ~GTInheritOption();
