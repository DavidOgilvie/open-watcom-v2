...
/****
***** Compare two strings, up to a specified maximum number of bytes.
***** Equivalent to strncmp().
****/

_WCRTLINK int _NEARFAR(_mbsnbcmp,_fmbsnbcmp)( const unsigned char _FFAR *s1, const unsigned char _FFAR *s2, size_t n )
{
    int                 status = 0;
    size_t              bytes;
