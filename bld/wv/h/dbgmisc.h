...
extern bool         ScanCmdAdd( void );
extern bool         ScanCmdMain( void );
extern bool         ScanCmdNogo( void );
extern char         *GetCmdAdd( char *buffer );
extern char         *GetCmdMain( char *buffer );
extern char         *GetCmdNogo( char *buffer );
