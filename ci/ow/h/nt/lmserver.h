/*
 *  lmserver.h  LAN Manager server functions
 *
 * =========================================================================
 *
 *                          Open Watcom Project
...
#define SV_PLATFORM_ID_OS2  400L
#define SV_PLATFORM_ID_NT   500L

/* Server major version mask */
#define MAJOR_VERSION_MASK  0x0000000FL

/* Server types */
#define SV_TYPE_WORKSTATION         0x00000001L
#define SV_TYPE_SERVER              0x00000002L
#define SV_TYPE_SQLSERVER           0x00000004L
#define SV_TYPE_DOMAIN_CTRL         0x00000008L
#define SV_TYPE_DOMAIN_BAKCTRL      0x00000010L
#define SV_TYPE_TIME_SOURCE         0x00000020L
#define SV_TYPE_AFP                 0x00000040L
#define SV_TYPE_NOVELL              0x00000080L
#define SV_TYPE_DOMAIN_MEMBER       0x00000100L
#define SV_TYPE_PRINTQ_SERVER       0x00000200L
#define SV_TYPE_DIALIN_SERVER       0x00000400L
#define SV_TYPE_XENIX_SERVER        0x00000800L
#define SV_TYPE_SERVER_UNIX         SV_TYPE_XENIX_SERVER
#define SV_TYPE_NT                  0x00001000L
#define SV_TYPE_WFW                 0x00002000L
#define SV_TYPE_SERVER_MFPN         0x00004000L
#define SV_TYPE_SERVER_NT           0x00008000L
#define SV_TYPE_POTENTIAL_BROWSER   0x00010000L
#define SV_TYPE_BACKUP_BROWSER      0x00020000L
#define SV_TYPE_MASTER_BROWSER      0x00040000L
#define SV_TYPE_DOMAIN_MASTER       0x00080000L
#define SV_TYPE_SERVER_OSF          0x00100000L
#define SV_TYPE_SERVER_VMS          0x00200000L
#define SV_TYPE_WINDOWS             0x00400000L
#define SV_TYPE_DFS                 0x00800000L
#define SV_TYPE_CLUSTER_NT          0x01000000L
#define SV_TYPE_TERMINALSERVER      0x02000000L
#define SV_TYPE_CLUSTER_VS_NT       0x04000000L
#define SV_TYPE_DCE                 0x10000000L
#define SV_TYPE_ALTERNATE_XPORT     0x20000000L
#define SV_TYPE_LOCAL_LIST_ONLY     0x40000000L
#define SV_TYPE_DOMAIN_ENUM         0x80000000L
#define SV_TYPE_ALL                 0xFFFFFFFFL

/* Server disc special value */
#define SV_NODISC   (-1L)

/* Server security types */
#define SV_USERSECURITY     1L
#define SV_SHARESECURITY    0L

/* Server visibility values */
#define SV_HIDDEN   1L
#define SV_VISIBLE  0L

/* Server parameter numbers */
...
#define SV_CACHEDDIRECTORY_PARMNUM                  587
...
#define SV_ENABLEAUTHENTICATIONUSERSHARING_PARMNUM  603

/* Server information levels */
...
#define SV_CONNECTIONNOSESSIONTIMEOUT_INFOLEVEL \
    (PARMNUM_BASE_INFOLEVEL + SV_CONNECTIONNOSESSIONTIMEOUT_PARMNUM)
...
/* Auto profile masks */
#define SW_AUTOPROF_LOAD_MASK   0x00000001L
#define SW_AUTOPROF_SAVE_MASK   0x00000002L

/* Server heuristics maximum size */
#define SV_MAX_SRV_HEUR_LEN 32

/* Server users per license */
#define SV_USERS_PER_LICENSE    5

/* Server transport flags */
#define SVTI2_REMAP_PIPE_NAMES  0x00000002L
#define SVTI2_SCOPED_NAME       0x00000004L
#define SVTI2_VALID_FLAGS       (SVTI2_REMAP_PIPE_NAMES | SVTI2_SCOPED_NAME)

/* Server capability flags */
#define SRV_SUPPORT_HASH_GENERATION 0x00000001L
#define SRV_HASH_GENERATION_ACTIVE  0x00000002L
...
typedef SERVER_INFO_100 *LPSERVER_INFO_100;
...
typedef SERVER_INFO_101 *PSERVER_INFO_101;
...
typedef SERVER_INFO_102 *LPSERVER_INFO_102;

/* Server information (level 103) */
...
typedef SERVER_INFO_103 *PSERVER_INFO_103;
typedef SERVER_INFO_103 *LPSERVER_INFO_103;
...
typedef SERVER_INFO_402 *PSERVER_INFO_402;
typedef SERVER_INFO_402 *LPSERVER_INFO_402;
...
typedef SERVER_INFO_403 *PSERVER_INFO_403;
typedef SERVER_INFO_403 *LPSERVER_INFO_403;
...
typedef SERVER_INFO_502 *PSERVER_INFO_502;
typedef SERVER_INFO_502 *LPSERVER_INFO_502;
...
typedef SERVER_INFO_503 *PSERVER_INFO_503;
typedef SERVER_INFO_503 *LPSERVER_INFO_503;

/* Server information (level 598) */
...
typedef SERVER_INFO_598 *PSERVER_INFO_598;
typedef SERVER_INFO_598 *LPSERVER_INFO_598;
...
typedef SERVER_INFO_599 *PSERVER_INFO_599;
typedef SERVER_INFO_599 *LPSERVER_INFO_599;

/* Server information (level 1005) */
typedef struct _SERVER_INFO_1005 {
    LMSTR   sv1005_comment;
} SERVER_INFO_1005;
typedef SERVER_INFO_1005    *PSERVER_INFO_1005;
typedef SERVER_INFO_1005    *LPSERVER_INFO_1005;

/* Server information (level 1010) */
typedef struct _SERVER_INFO_1010 {
    LONG    sv1010_disc;
} SERVER_INFO_1010;
typedef SERVER_INFO_1010    *PSERVER_INFO_1010;
typedef SERVER_INFO_1010    *LPSERVER_INFO_1010;

/* Server information (level 1016) */
typedef struct _SERVER_INFO_1016 {
    BOOL    sv1016_hidden;
} SERVER_INFO_1016;
typedef SERVER_INFO_1016    *PSERVER_INFO_1016;
typedef SERVER_INFO_1016    *LPSERVER_INFO_1016;

/* Server information (level 1017) */
typedef struct _SERVER_INFO_1017 {
    DWORD   sv1017_announce;
} SERVER_INFO_1017;
typedef SERVER_INFO_1017    *PSERVER_INFO_1017;
typedef SERVER_INFO_1017    *LPSERVER_INFO_1017;

/* Server information (level 1018) */
typedef struct _SERVER_INFO_1018 {
    DWORD   sv1018_anndelta;
} SERVER_INFO_1018;
typedef SERVER_INFO_1018    *PSERVER_INFO_1018;
typedef SERVER_INFO_1018    *LPSERVER_INFO_1018;

/* Server information (level 1107) */
typedef struct _SERVER_INFO_1107 {
    DWORD   sv1107_users;
} SERVER_INFO_1107;
typedef SERVER_INFO_1107    *PSERVER_INFO_1107;
typedef SERVER_INFO_1107    *LPSERVER_INFO_1107;

/* Server information (level 1501) */
typedef struct _SERVER_INFO_1501 {
    DWORD   sv1501_sessopens;
} SERVER_INFO_1501;
typedef SERVER_INFO_1501    *PSERVER_INFO_1501;
typedef SERVER_INFO_1501    *LPSERVER_INFO_1501;

/* Server information (level 1502) */
typedef struct _SERVER_INFO_1502 {
    DWORD   sv1502_sessvcs;
} SERVER_INFO_1502;
typedef SERVER_INFO_1502    *PSERVER_INFO_1502;
typedef SERVER_INFO_1502    *LPSERVER_INFO_1502;

/* Server information (level 1503) */
typedef struct _SERVER_INFO_1503 {
    DWORD   sv1503_opensearch;
} SERVER_INFO_1503;
typedef SERVER_INFO_1503    *PSERVER_INFO_1503;
typedef SERVER_INFO_1503    *LPSERVER_INFO_1503;

/* Server information (level 1506) */
typedef struct _SERVER_INFO_1506 {
    DWORD   sv1506_maxworkitems;
} SERVER_INFO_1506;
typedef SERVER_INFO_1506    *PSERVER_INFO_1506;
typedef SERVER_INFO_1506    *LPSERVER_INFO_1506;

/* Server information (level 1509) */
typedef struct _SERVER_INFO_1509 {
    DWORD   sv1509_maxrawbuflen;
} SERVER_INFO_1509;
typedef SERVER_INFO_1509    *PSERVER_INFO_1509;
typedef SERVER_INFO_1509    *LPSERVER_INFO_1509;

/* Server information (level 1510) */
typedef struct _SERVER_INFO_1510 {
    DWORD   sv1510_sessusers;
} SERVER_INFO_1510;
typedef SERVER_INFO_1510    *PSERVER_INFO_1510;
typedef SERVER_INFO_1510    *LPSERVER_INFO_1510;

/* Server information (level 1511) */
typedef struct _SERVER_INFO_1511 {
    DWORD   sv1511_sessconns;
} SERVER_INFO_1511;
typedef SERVER_INFO_1511    *PSERVER_INFO_1511;
typedef SERVER_INFO_1511    *LPSERVER_INFO_1511;

/* Server information (level 1512) */
typedef struct _SERVER_INFO_1512 {
    DWORD   sv1512_maxnonpagedmemoryusage;
} SERVER_INFO_1512;
typedef SERVER_INFO_1512    *PSERVER_INFO_1512;
typedef SERVER_INFO_1512    *LPSERVER_INFO_1512;

/* Server information (level 1513) */
typedef struct _SERVER_INFO_1513 {
    DWORD   sv1513_maxpagedmemoryusage;
} SERVER_INFO_1513;
typedef SERVER_INFO_1513    *PSERVER_INFO_1513;
typedef SERVER_INFO_1513    *LPSERVER_INFO_1513;

/* Server information (level 1514) */
typedef struct _SERVER_INFO_1514 {
    BOOL    sv1514_enablesoftcompat;
} SERVER_INFO_1514;
typedef SERVER_INFO_1514    *PSERVER_INFO_1514;
typedef SERVER_INFO_1514    *LPSERVER_INFO_1514;

/* Server information (level 1515) */
typedef struct _SERVER_INFO_1515 {
    BOOL    sv1515_enableforcedlogoff;
} SERVER_INFO_1515;
typedef SERVER_INFO_1515    *PSERVER_INFO_1515;
typedef SERVER_INFO_1515    *LPSERVER_INFO_1515;

/* Server information (level 1516) */
typedef struct _SERVER_INFO_1516 {
    BOOL    sv1516_timesource;
} SERVER_INFO_1516;
typedef SERVER_INFO_1516    *PSERVER_INFO_1516;
typedef SERVER_INFO_1516    *LPSERVER_INFO_1516;

/* Server information (level 1518) */
typedef struct _SERVER_INFO_1518 {
    BOOL    sv1518_lmannounce;
} SERVER_INFO_1518;
typedef SERVER_INFO_1518    *PSERVER_INFO_1518;
typedef SERVER_INFO_1518    *LPSERVER_INFO_1518;

/* Server information (level 1520) */
typedef struct _SERVER_INFO_1520 {
    DWORD   sv1520_maxcopyreadlen;
} SERVER_INFO_1520;
typedef SERVER_INFO_1520    *PSERVER_INFO_1520;
typedef SERVER_INFO_1520    *LPSERVER_INFO_1520;

/* Server information (level 1521) */
typedef struct _SERVER_INFO_1521 {
    DWORD   sv1521_maxcopywritelen;
} SERVER_INFO_1521;
typedef SERVER_INFO_1521    *PSERVER_INFO_1521;
typedef SERVER_INFO_1521    *LPSERVER_INFO_1521;

/* Server information (level 1522) */
typedef struct _SERVER_INFO_1522 {
    DWORD   sv1522_minkeepsearch;
} SERVER_INFO_1522;
typedef SERVER_INFO_1522    *PSERVER_INFO_1522;
typedef SERVER_INFO_1522    *LPSERVER_INFO_1522;

/* Server information (level 1523) */
typedef struct _SERVER_INFO_1523 {
    DWORD   sv1523_maxkeepsearch;
} SERVER_INFO_1523;
typedef SERVER_INFO_1523    *PSERVER_INFO_1523;
typedef SERVER_INFO_1523    *LPSERVER_INFO_1523;

/* Server information (level 1524) */
typedef struct _SERVER_INFO_1524 {
    DWORD   sv1524_minkeepcomplsearch;
} SERVER_INFO_1524;
typedef SERVER_INFO_1524    *PSERVER_INFO_1524;
typedef SERVER_INFO_1524    *LPSERVER_INFO_1524;

/* Server information (level 1525) */
typedef struct _SERVER_INFO_1525 {
    DWORD   sv1525_maxkeepcomplsearch;
} SERVER_INFO_1525;
typedef SERVER_INFO_1525    *PSERVER_INFO_1525;
typedef SERVER_INFO_1525    *LPSERVER_INFO_1525;

/* Server information (level 1528) */
typedef struct _SERVER_INFO_1528 {
    DWORD   sv1528_scavtimeout;
} SERVER_INFO_1528;
typedef SERVER_INFO_1528    *PSERVER_INFO_1528;
typedef SERVER_INFO_1528    *LPSERVER_INFO_1528;

/* Server information (level 1529) */
typedef struct _SERVER_INFO_1529 {
    DWORD   sv1529_minrcvqueue;
} SERVER_INFO_1529;
typedef SERVER_INFO_1529    *PSERVER_INFO_1529;
typedef SERVER_INFO_1529    *LPSERVER_INFO_1529;

/* Server information (level 1530) */
typedef struct _SERVER_INFO_1530 {
    DWORD   sv1530_minfreeworkitems;
} SERVER_INFO_1530;
typedef SERVER_INFO_1530    *PSERVER_INFO_1530;
typedef SERVER_INFO_1530    *LPSERVER_INFO_1530;

/* Server information (level 1533) */
typedef struct _SERVER_INFO_1533 {
    DWORD   sv1533_maxmpxct;
} SERVER_INFO_1533;
typedef SERVER_INFO_1533    *PSERVER_INFO_1533;
typedef SERVER_INFO_1533    *LPSERVER_INFO_1533;

/* Server information (level 1534) */
typedef struct _SERVER_INFO_1534 {
    DWORD   sv1534_oplockbreakwait;
} SERVER_INFO_1534;
typedef SERVER_INFO_1534    *PSERVER_INFO_1534;
typedef SERVER_INFO_1534    *LPSERVER_INFO_1534;

/* Server information (level 1535) */
typedef struct _SERVER_INFO_1535 {
    DWORD   sv1535_oplockbreakresponsewait;
} SERVER_INFO_1535;
typedef SERVER_INFO_1535    *PSERVER_INFO_1535;
typedef SERVER_INFO_1535    *LPSERVER_INFO_1535;

/* Server information (level 1536) */
typedef struct _SERVER_INFO_1536 {
    BOOL    sv1536_enableoplocks;
} SERVER_INFO_1536;
typedef SERVER_INFO_1536    *PSERVER_INFO_1536;
typedef SERVER_INFO_1536    *LPSERVER_INFO_1536;

/* Server information (level 1537) */
typedef struct _SERVER_INFO_1537 {
    BOOL    sv1537_enableoplockforceclose;
} SERVER_INFO_1537;
typedef SERVER_INFO_1537    *PSERVER_INFO_1537;
typedef SERVER_INFO_1537    *LPSERVER_INFO_1537;

/* Server information (level 1538) */
typedef struct _SERVER_INFO_1538 {
    BOOL    sv1538_enablefcbopens;
} SERVER_INFO_1538;
typedef SERVER_INFO_1538    *PSERVER_INFO_1538;
typedef SERVER_INFO_1538    *LPSERVER_INFO_1538;

/* Server information (level 1539) */
typedef struct _SERVER_INFO_1539 {
    BOOL    sv1539_enableraw;
} SERVER_INFO_1539;
typedef SERVER_INFO_1539    *PSERVER_INFO_1539;
typedef SERVER_INFO_1539    *LPSERVER_INFO_1539;

/* Server information (level 1540) */
typedef struct _SERVER_INFO_1540 {
    BOOL    sv1540_enablesharednetdrives;
} SERVER_INFO_1540;
typedef SERVER_INFO_1540    *PSERVER_INFO_1540;
typedef SERVER_INFO_1540    *LPSERVER_INFO_1540;

/* Server information (level 1541) */
typedef struct _SERVER_INFO_1541 {
    BOOL    sv1541_minfreeconnections;
} SERVER_INFO_1541;
typedef SERVER_INFO_1541    *PSERVER_INFO_1541;
typedef SERVER_INFO_1541    *LPSERVER_INFO_1541;

/* Server information (level 1542) */
typedef struct _SERVER_INFO_1542 {
    BOOL    sv1542_maxfreeconnections;
} SERVER_INFO_1542;
typedef SERVER_INFO_1542    *PSERVER_INFO_1542;
typedef SERVER_INFO_1542    *LPSERVER_INFO_1542;

/* Server information (level 1543) */
typedef struct _SERVER_INFO_1543 {
    DWORD   sv1543_initsesstable;
} SERVER_INFO_1543;
typedef SERVER_INFO_1543    *PSERVER_INFO_1543;
typedef SERVER_INFO_1543    *LPSERVER_INFO_1543;

/* Server information (level 1544) */
typedef struct _SERVER_INFO_1544 {
    DWORD   sv1544_initconntable;
} SERVER_INFO_1544;
typedef SERVER_INFO_1544    *PSERVER_INFO_1544;
typedef SERVER_INFO_1544    *LPSERVER_INFO_1544;

/* Server information (level 1545) */
typedef struct _SERVER_INFO_1545 {
    DWORD   sv1545_initfiletable;
} SERVER_INFO_1545;
typedef SERVER_INFO_1545    *PSERVER_INFO_1545;
typedef SERVER_INFO_1545    *LPSERVER_INFO_1545;

/* Server information (level 1546) */
typedef struct _SERVER_INFO_1546 {
    DWORD   sv1546_initsearchtable;
} SERVER_INFO_1546;
typedef SERVER_INFO_1546    *PSERVER_INFO_1546;
typedef SERVER_INFO_1546    *LPSERVER_INFO_1546;

/* Server information (level 1547) */
typedef struct _SERVER_INFO_1547 {
    DWORD   sv1547_alertschedule;
} SERVER_INFO_1547;
typedef SERVER_INFO_1547    *PSERVER_INFO_1547;
typedef SERVER_INFO_1547    *LPSERVER_INFO_1547;

/* Server information (level 1548) */
typedef struct _SERVER_INFO_1548 {
    DWORD   sv1548_errorthreshold;
} SERVER_INFO_1548;
typedef SERVER_INFO_1548    *PSERVER_INFO_1548;
typedef SERVER_INFO_1548    *LPSERVER_INFO_1548;

/* Server information (level 1549) */
typedef struct _SERVER_INFO_1549 {
    DWORD   sv1549_networkerrorthreshold;
} SERVER_INFO_1549;
typedef SERVER_INFO_1549    *PSERVER_INFO_1549;
typedef SERVER_INFO_1549    *LPSERVER_INFO_1549;

/* Server information (level 1550) */
typedef struct _SERVER_INFO_1550 {
    DWORD   sv1550_diskspacethreshold;
} SERVER_INFO_1550;
typedef SERVER_INFO_1550    *PSERVER_INFO_1550;
typedef SERVER_INFO_1550    *LPSERVER_INFO_1550;

/* Server information (level 1552) */
typedef struct _SERVER_INFO_1552 {
    DWORD   sv1552_maxlinkdelay;
} SERVER_INFO_1552;
typedef SERVER_INFO_1552    *PSERVER_INFO_1552;
typedef SERVER_INFO_1552    *LPSERVER_INFO_1552;

/* Server information (level 1553) */
typedef struct _SERVER_INFO_1553 {
    DWORD   sv1553_minlinkthroughput;
} SERVER_INFO_1553;
typedef SERVER_INFO_1553    *PSERVER_INFO_1553;
typedef SERVER_INFO_1553    *LPSERVER_INFO_1553;

/* Server information (level 1554) */
typedef struct _SERVER_INFO_1554 {
    DWORD   sv1554_linkinfovalidtime;
} SERVER_INFO_1554;
typedef SERVER_INFO_1554    *PSERVER_INFO_1554;
typedef SERVER_INFO_1554    *LPSERVER_INFO_1554;

/* Server information (level 1555) */
typedef struct _SERVER_INFO_1555 {
    DWORD   sv1555_scavqosinfoupdatetime;
} SERVER_INFO_1555;
typedef SERVER_INFO_1555    *PSERVER_INFO_1555;
typedef SERVER_INFO_1555    *LPSERVER_INFO_1555;

/* Server information (level 1556) */
typedef struct _SERVER_INFO_1556 {
    DWORD   sv1556_maxworkitemidletime;
} SERVER_INFO_1556;
typedef SERVER_INFO_1556    *PSERVER_INFO_1556;
typedef SERVER_INFO_1556    *LPSERVER_INFO_1556;

/* Server information (level 1557) */
typedef struct _SERVER_INFO_1557 {
    DWORD   sv1557_maxrawworkitems;
} SERVER_INFO_1557;
typedef SERVER_INFO_1557    *PSERVER_INFO_1557;
typedef SERVER_INFO_1557    *LPSERVER_INFO_1557;

/* Server information (level 1560) */
typedef struct _SERVER_INFO_1558 {
    DWORD   sv1560_producttype;
} SERVER_INFO_1560;
typedef SERVER_INFO_1560    *PSERVER_INFO_1560;
typedef SERVER_INFO_1560    *LPSERVER_INFO_1560;

/* Server information (level 1561) */
typedef struct _SERVER_INFO_1561 {
    DWORD   sv1561_serversize;
} SERVER_INFO_1561;
typedef SERVER_INFO_1561    *PSERVER_INFO_1561;
typedef SERVER_INFO_1561    *LPSERVER_INFO_1561;

/* Server information (level 1562) */
typedef struct _SERVER_INFO_1562 {
    DWORD   sv1562_connectionlessautodisc;
} SERVER_INFO_1562;
typedef SERVER_INFO_1562    *PSERVER_INFO_1562;
typedef SERVER_INFO_1562    *LPSERVER_INFO_1562;

/* Server information (level 1563) */
typedef struct _SERVER_INFO_1563 {
    DWORD   sv1563_sharingviolationretries;
} SERVER_INFO_1563;
typedef SERVER_INFO_1563    *PSERVER_INFO_1563;
typedef SERVER_INFO_1563    *LPSERVER_INFO_1563;

/* Server information (level 1564) */
typedef struct _SERVER_INFO_1564 {
    DWORD   sv1564_sharingviolationdelay;
} SERVER_INFO_1564;
typedef SERVER_INFO_1564    *PSERVER_INFO_1564;
typedef SERVER_INFO_1564    *LPSERVER_INFO_1564;

/* Server information (level 1565) */
typedef struct _SERVER_INFO_1565 {
    DWORD   sv1565_maxglobalopensearch;
} SERVER_INFO_1565;
typedef SERVER_INFO_1565    *PSERVER_INFO_1565;
typedef SERVER_INFO_1565    *LPSERVER_INFO_1565;

/* Server information (level 1566) */
typedef struct _SERVER_INFO_1566 {
    BOOL    sv1566_removeduplicatesearches;
} SERVER_INFO_1566;
typedef SERVER_INFO_1566    *PSERVER_INFO_1566;
typedef SERVER_INFO_1566    *LPSERVER_INFO_1566;

/* Server information (level 1567) */
typedef struct _SERVER_INFO_1567 {
    DWORD   sv1567_lockviolationretries;
} SERVER_INFO_1567;
typedef SERVER_INFO_1567    *PSERVER_INFO_1567;
typedef SERVER_INFO_1567    *LPSERVER_INFO_1567;

/* Server information (level 1568) */
typedef struct _SERVER_INFO_1568 {
    DWORD   sv1568_lockviolationoffset;
} SERVER_INFO_1568;
typedef SERVER_INFO_1568    *PSERVER_INFO_1568;
typedef SERVER_INFO_1568    *LPSERVER_INFO_1568;

/* Server information (level 1569) */
typedef struct _SERVER_INFO_1569 {
    DWORD   sv1569_lockviolationdelay;
} SERVER_INFO_1569;
typedef SERVER_INFO_1569    *PSERVER_INFO_1569;
typedef SERVER_INFO_1569    *LPSERVER_INFO_1569;

/* Server information (level 1570) */
typedef struct _SERVER_INFO_1570 {
    DWORD   sv1570_mdlreadswitchover;
} SERVER_INFO_1570;
typedef SERVER_INFO_1570    *PSERVER_INFO_1570;
typedef SERVER_INFO_1570    *LPSERVER_INFO_1570;

/* Server information (level 1571) */
typedef struct _SERVER_INFO_1571 {
    DWORD   sv1571_cachedopenlimit;
} SERVER_INFO_1571;
typedef SERVER_INFO_1571    *PSERVER_INFO_1571;
typedef SERVER_INFO_1571    *LPSERVER_INFO_1571;

/* Server information (level 1572) */
typedef struct _SERVER_INFO_1572 {
    DWORD   sv1572_criticalthreads;
} SERVER_INFO_1572;
typedef SERVER_INFO_1572    *PSERVER_INFO_1572;
typedef SERVER_INFO_1572    *LPSERVER_INFO_1572;

/* Server information (level 1573) */
typedef struct _SERVER_INFO_1573 {
    DWORD   sv1573_restrictnullsessaccess;
} SERVER_INFO_1573;
typedef SERVER_INFO_1573    *PSERVER_INFO_1573;
typedef SERVER_INFO_1573    *LPSERVER_INFO_1573;

/* Server information (level 1574) */
typedef struct _SERVER_INFO_1574 {
    DWORD   sv1574_enablewfw311directipx;
} SERVER_INFO_1574;
typedef SERVER_INFO_1574    *PSERVER_INFO_1574;
typedef SERVER_INFO_1574    *LPSERVER_INFO_1574;

/* Server information (level 1575) */
typedef struct _SERVER_INFO_1575 {
    DWORD   sv1575_otherqueueaffinity;
} SERVER_INFO_1575;
typedef SERVER_INFO_1575    *PSERVER_INFO_1575;
typedef SERVER_INFO_1575    *LPSERVER_INFO_1575;

/* Server information (level 1576) */
typedef struct _SERVER_INFO_1576 {
    DWORD   sv1576_queuesamplesecs;
} SERVER_INFO_1576;
typedef SERVER_INFO_1576    *PSERVER_INFO_1576;
typedef SERVER_INFO_1576    *LPSERVER_INFO_1576;

/* Server information (level 1577) */
typedef struct _SERVER_INFO_1577 {
    DWORD   sv1577_balancecount;
} SERVER_INFO_1577;
typedef SERVER_INFO_1577    *PSERVER_INFO_1577;
typedef SERVER_INFO_1577    *LPSERVER_INFO_1577;

/* Server information (level 1578) */
typedef struct _SERVER_INFO_1578 {
    DWORD   sv1578_preferredaffinity;
} SERVER_INFO_1578;
typedef SERVER_INFO_1578    *PSERVER_INFO_1578;
typedef SERVER_INFO_1578    *LPSERVER_INFO_1578;

/* Server information (level 1579) */
typedef struct _SERVER_INFO_1579 {
    DWORD   sv1579_maxfreerfcbs;
} SERVER_INFO_1579;
typedef SERVER_INFO_1579    *PSERVER_INFO_1579;
typedef SERVER_INFO_1579    *LPSERVER_INFO_1579;

/* Server information (level 1580) */
typedef struct _SERVER_INFO_1580 {
    DWORD   sv1580_maxfreemfcbs;
} SERVER_INFO_1580;
typedef SERVER_INFO_1580    *PSERVER_INFO_1580;
typedef SERVER_INFO_1580    *LPSERVER_INFO_1580;

/* Server information (level 1581) */
typedef struct _SERVER_INFO_1581 {
    DWORD   sv1581_maxfreemlcbs;
} SERVER_INFO_1581;
typedef SERVER_INFO_1581    *PSERVER_INFO_1581;
typedef SERVER_INFO_1581    *LPSERVER_INFO_1581;

/* Server information (level 1582) */
typedef struct _SERVER_INFO_1582 {
    DWORD   sv1582_maxfreepagedpoolchunks;
} SERVER_INFO_1582;
typedef SERVER_INFO_1582    *PSERVER_INFO_1582;
typedef SERVER_INFO_1582    *LPSERVER_INFO_1582;

/* Server information (level 1583) */
typedef struct _SERVER_INFO_1583 {
    DWORD   sv1583_minpagedpoolchunksize;
} SERVER_INFO_1583;
typedef SERVER_INFO_1583    *PSERVER_INFO_1583;
typedef SERVER_INFO_1583    *LPSERVER_INFO_1583;

/* Server information (level 1584) */
typedef struct _SERVER_INFO_1584 {
    DWORD   sv1584_maxpagedpoolchunksize;
} SERVER_INFO_1584;
typedef SERVER_INFO_1584    *PSERVER_INFO_1584;
typedef SERVER_INFO_1584    *LPSERVER_INFO_1584;

/* Server information (level 1585) */
typedef struct _SERVER_INFO_1585 {
    BOOL    sv1585_sendsfrompreferredprocessor;
} SERVER_INFO_1585;
typedef SERVER_INFO_1585    *PSERVER_INFO_1585;
typedef SERVER_INFO_1585    *LPSERVER_INFO_1585;

/* Server information (level 1586) */
typedef struct _SERVER_INFO_1586 {
    DWORD   sv1586_maxthreadsperqueue;
} SERVER_INFO_1586;
typedef SERVER_INFO_1586    *PSERVER_INFO_1586;
typedef SERVER_INFO_1586    *LPSERVER_INFO_1586;

/* Server information (level 1587) */
typedef struct _SERVER_INFO_1587 {
    DWORD   sv1587_cacheddirectorylimit;
} SERVER_INFO_1587;
typedef SERVER_INFO_1587    *PSERVER_INFO_1587;
typedef SERVER_INFO_1587    *LPSERVER_INFO_1587;

/* Server information (level 1588) */
typedef struct _SERVER_INFO_1588 {
    DWORD   sv1588_maxcopylength;
} SERVER_INFO_1588;
typedef SERVER_INFO_1588    *PSERVER_INFO_1588;
typedef SERVER_INFO_1588    *LPSERVER_INFO_1588;

/* Server information (level 1590) */
typedef struct _SERVER_INFO_1590 {
    DWORD   sv1590_enablecompression;
} SERVER_INFO_1590;
typedef SERVER_INFO_1590    *PSERVER_INFO_1590;
typedef SERVER_INFO_1590    *LPSERVER_INFO_1590;

/* Server information (level 1591) */
typedef struct _SERVER_INFO_1591 {
    DWORD   sv1591_autosharewks;
} SERVER_INFO_1591;
typedef SERVER_INFO_1591    *PSERVER_INFO_1591;
typedef SERVER_INFO_1591    *LPSERVER_INFO_1591;

/* Server information (level 1592) */
typedef struct _SERVER_INFO_1592 {
    DWORD   sv1592_autosharewks;
} SERVER_INFO_1592;
typedef SERVER_INFO_1592    *PSERVER_INFO_1592;
typedef SERVER_INFO_1592    *LPSERVER_INFO_1592;

/* Server information (level 1593) */
typedef struct _SERVER_INFO_1593 {
    DWORD   sv1593_enablesecuritysignature;
} SERVER_INFO_1593;
typedef SERVER_INFO_1593    *PSERVER_INFO_1593;
typedef SERVER_INFO_1593    *LPSERVER_INFO_1593;

/* Server information (level 1594) */
typedef struct _SERVER_INFO_1594 {
    DWORD   sv1594_requiresecuritysignature;
} SERVER_INFO_1594;
typedef SERVER_INFO_1594    *PSERVER_INFO_1594;
typedef SERVER_INFO_1594    *LPSERVER_INFO_1594;

/* Server information (level 1595) */
typedef struct _SERVER_INFO_1595 {
    DWORD   sv1595_minclientbuffersize;
} SERVER_INFO_1595;
typedef SERVER_INFO_1595    *PSERVER_INFO_1595;
typedef SERVER_INFO_1595    *LPSERVER_INFO_1595;

/* Server information (level 1596) */
typedef struct _SERVER_INFO_1596 {
    DWORD   sv1596_ConnectionNoSessionsTimeout;
} SERVER_INFO_1596;
typedef SERVER_INFO_1596    *PSERVER_INFO_1596;
typedef SERVER_INFO_1596    *LPSERVER_INFO_1596;

/* Server information (level 1597) */
typedef struct _SERVER_INFO_1597 {
    DWORD   sv1597_IdleThreadTimeOut;
} SERVER_INFO_1597;
typedef SERVER_INFO_1597    *PSERVER_INFO_1597;
typedef SERVER_INFO_1597    *LPSERVER_INFO_1597;

/* Server information (level 1598) */
typedef struct _SERVER_INFO_1598 {
    DWORD   sv1598_enableW9xsecuritysignature;
} SERVER_INFO_1598;
typedef SERVER_INFO_1598    *PSERVER_INFO_1598;
typedef SERVER_INFO_1598    *LPSERVER_INFO_1598;

/* Server information (level 1599) */
typedef struct _SERVER_INFO_1599 {
    BOOLEAN sv1598_enforcekerberosreauthentication;
} SERVER_INFO_1599;
typedef SERVER_INFO_1599    *PSERVER_INFO_1599;
typedef SERVER_INFO_1599    *LPSERVER_INFO_1599;

/* Server information (level 1600) */
typedef struct _SERVER_INFO_1600 {
    BOOLEAN sv1598_disabledos;
} SERVER_INFO_1600;
typedef SERVER_INFO_1600    *PSERVER_INFO_1600;
typedef SERVER_INFO_1600    *LPSERVER_INFO_1600;

/* Server information (level 1601) */
typedef struct _SERVER_INFO_1601 {
    DWORD   sv1598_lowdiskspaceminimum;
} SERVER_INFO_1601;
typedef SERVER_INFO_1601    *PSERVER_INFO_1601;
typedef SERVER_INFO_1601    *LPSERVER_INFO_1601;

/* Server information (level 1602) */
typedef struct _SERVER_INFO_1602 {
    BOOL    sv1602_disablestrictnamechecking;
} SERVER_INFO_1602;
typedef SERVER_INFO_1602    *PSERVER_INFO_1602;
typedef SERVER_INFO_1602    *LPSERVER_INFO_1602;

/* Server transport information (level 0) */
...
typedef SERVER_TRANSPORT_INFO_0 *PSERVER_TRANSPORT_INFO_0;
typedef SERVER_TRANSPORT_INFO_0 *LPSERVER_TRANSPORT_INFO_0;

/* Server transport information (level 1) */
...
typedef SERVER_TRANSPORT_INFO_1 *LPSERVER_TRANSPORT_INFO_1;

/* Server transport information (level 2) */
...
typedef SERVER_TRANSPORT_INFO_2 *PSERVER_TRANSPORT_INFO_2;
typedef SERVER_TRANSPORT_INFO_2 *LPSERVER_TRANSPORT_INFO_2;

/* Server transport information (level 3) */
...
typedef SERVER_TRANSPORT_INFO_3 *PSERVER_TRANSPORT_INFO_3;
typedef SERVER_TRANSPORT_INFO_3 *LPSERVER_TRANSPORT_INFO_3;

/* Functions in NETAPI32.DLL */
NET_API_STATUS NET_API_FUNCTION NetServerComputerNameAdd( LMSTR, LMSTR, LMSTR );
NET_API_STATUS NET_API_FUNCTION NetServerComputerNameDel( LMSTR, LMSTR );
NET_API_STATUS NET_API_FUNCTION NetServerDiskEnum( LMSTR, DWORD, LPBYTE *, DWORD, LPDWORD, LPDWORD, LPDWORD );
NET_API_STATUS NET_API_FUNCTION NetServerEnum( LMCSTR, DWORD, LPBYTE *, DWORD, LPDWORD, LPDWORD, DWORD, LMCSTR, LPDWORD );
NET_API_STATUS NET_API_FUNCTION NetServerEnumEx( LMCSTR, DWORD, LPBYTE *, DWORD, LPDWORD, LPDWORD, DWORD, LMCSTR, LMCSTR );
NET_API_STATUS NET_API_FUNCTION NetServerGetInfo( LMSTR, DWORD, LPBYTE * );
NET_API_STATUS NET_API_FUNCTION NetServerSetInfo( LMSTR, DWORD, LPBYTE, LPDWORD );
NET_API_STATUS NET_API_FUNCTION NetServerTransportAdd( LMSTR, DWORD, LPBYTE );
NET_API_STATUS NET_API_FUNCTION NetServerTransportAddEx( LMSTR, DWORD, LPBYTE );
NET_API_STATUS NET_API_FUNCTION NetServerTransportDel( LMSTR, DWORD, LPBYTE );
NET_API_STATUS NET_API_FUNCTION NetServerTransportEnum( LMSTR, DWORD, LPBYTE *, DWORD, LPDWORD, LPDWORD, LPDWORD );

/* Functions in ADVAPI32.DLL */
WINADVAPI BOOL WINAPI   SetServiceBits( SERVICE_STATUS_HANDLE, DWORD, BOOL, BOOL );
