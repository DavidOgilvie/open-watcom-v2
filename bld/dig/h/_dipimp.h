...
pick( dip_status,       LoadInfo,           ( FILE *, imp_image_handle * ) )
...
pick( walk_result,      WalkTypeList,       ( imp_image_handle *, imp_mod_handle, DIP_IMP_TYPE_WALKER *, imp_type_handle *, void * ) )
pick( imp_mod_handle,   TypeMod,            ( imp_image_handle *, imp_type_handle * ) )
pick( dip_status,       TypeInfo,           ( imp_image_handle *, imp_type_handle *, location_context *, dig_type_info * ) )
...
pick( dip_status,       SymObjType,         ( imp_image_handle *, imp_sym_handle *, imp_type_handle *, dig_type_info * ) )
...
pick( walk_result,      WalkFileList,       ( imp_image_handle *, imp_mod_handle, DIP_IMP_CUE_WALKER *, imp_cue_handle *, void * ) )
...
pick( walk_result,      WalkSymListEx,      ( imp_image_handle *, symbol_source, void *, DIP_IMP_SYM_WALKER *, imp_sym_handle *, location_context *lc, void * ) )
