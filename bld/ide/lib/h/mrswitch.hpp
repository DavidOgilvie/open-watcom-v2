...
#ifndef mrswitch_class
#define mrswitch_class

#include "mswitch.hpp"

WCLASS MRSwitch : public MSwitch
{
    Declare( MRSwitch )
    public:
        MRSwitch( const char* name=NULL ) : MSwitch( name ) {}
        MRSwitch( WTokenFile& fil, WString& tok, const char* group );
        ~MRSwitch() {}
