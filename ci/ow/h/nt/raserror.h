/*
 *  raserror.h  Remote Access Service (RAS) error codes
 *
 * =========================================================================
 *
 *                          Open Watcom Project
...
#if (WINVER < 0x0600)
    #define ERROR_WRITING_INITBS                    (RASBASE + 106)
#endif
...
#if (WINVER < 0x0600)
    #define ERROR_IPXCP_NO_DAILOUT_CONFIGURED       (RASBASE + 124)
    #define ERROR_IPXCP_NO_DAILIN_CONFIGURED        (RASBASE + 125)
#endif
...
#define ERORR_OAKLEY_NO_PEER_CERT                   (RASBASE + 190)
