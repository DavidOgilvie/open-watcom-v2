/*
 *  ipifcons.h  IP interface constants
 *
 * =========================================================================
 *
 *                          Open Watcom Project
...
#define IF_TYPE_DOSCCABLE_UPSTREAM                  129
...
/* Interface administrative status values */
#define IF_ADMIN_STATUS_UP      1
#define IF_ADMIN_STATUS_DOWN    2
#define IF_ADMIN_STATUS_TESTING 3

/* Management Information Base (MIB) types */
...
/* Management Information Base (MIB) status values */
...
/* Internal interface operational status values */
