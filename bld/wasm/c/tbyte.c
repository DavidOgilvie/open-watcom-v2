...
static ELD tab_plus_exp[MAX_EXP_INDEX] = {
    { { CONSTU32( 0x00000000 ), CONSTU32( 0x00000000 ), CONSTU32( 0xA0000000 ) }, 0x4002 }, // 1e1L
    { { CONSTU32( 0x00000000 ), CONSTU32( 0x00000000 ), CONSTU32( 0xC8000000 ) }, 0x4005 }, // 1e2L
    { { CONSTU32( 0x00000000 ), CONSTU32( 0x00000000 ), CONSTU32( 0x9C400000 ) }, 0x400C }, // 1e4L
    { { CONSTU32( 0x00000000 ), CONSTU32( 0x00000000 ), CONSTU32( 0xBEBC2000 ) }, 0x4019 }, // 1e8L
    { { CONSTU32( 0x00000000 ), CONSTU32( 0x04000000 ), CONSTU32( 0x8E1BC9BF ) }, 0x4034 }, // 1e16L
    { { CONSTU32( 0xF0200000 ), CONSTU32( 0x2B70B59D ), CONSTU32( 0x9DC5ADA8 ) }, 0x4069 }, // 1e32L
    { { CONSTU32( 0x3CBF6B71 ), CONSTU32( 0xFFCFA6D5 ), CONSTU32( 0xC2781F49 ) }, 0x40D3 }, // 1e64L
    { { CONSTU32( 0xC66F336B ), CONSTU32( 0x80E98CDF ), CONSTU32( 0x93BA47C9 ) }, 0x41A8 }, // 1e128L
    { { CONSTU32( 0xDDBB9018 ), CONSTU32( 0x9DF9DE8D ), CONSTU32( 0xAA7EEBFB ) }, 0x4351 }, // 1e256L
    { { CONSTU32( 0xCC655C4B ), CONSTU32( 0xA60E91C6 ), CONSTU32( 0xE319A0AE ) }, 0x46A3 }, // 1e512L
    { { CONSTU32( 0x650D3D17 ), CONSTU32( 0x81750C17 ), CONSTU32( 0xC9767586 ) }, 0x4D48 }, // 1e1024L
    { { CONSTU32( 0xA74D28B1 ), CONSTU32( 0xC53D5DE4 ), CONSTU32( 0x9E8b3B5D ) }, 0x5A92 }, // 1e2048L
    { { CONSTU32( 0xC94C14F7 ), CONSTU32( 0x8A20979A ), CONSTU32( 0xC4605202 ) }, 0x7525 }  // 1e4096L
};

static ELD tab_minus_exp[MAX_EXP_INDEX] = {
    { { CONSTU32( 0xCCCCCCCD ), CONSTU32( 0xCCCCCCCC ), CONSTU32( 0xCCCCCCCC ) }, 0x3FFB }, // 1e-1L
    { { CONSTU32( 0x3D70A3D7 ), CONSTU32( 0x70A3D70A ), CONSTU32( 0xA3D70A3D ) }, 0x3FF8 }, // 1e-2L
    { { CONSTU32( 0xD3C36113 ), CONSTU32( 0xE219652B ), CONSTU32( 0xD1B71758 ) }, 0x3FF1 }, // 1e-4L
    { { CONSTU32( 0xFDC20D2A ), CONSTU32( 0x8461CEFC ), CONSTU32( 0xABCC7711 ) }, 0x3FE4 }, // 1e-8L
    { { CONSTU32( 0x4C2EBE65 ), CONSTU32( 0xC44DE15B ), CONSTU32( 0xE69594BE ) }, 0x3FC9 }, // 1e-16L
    { { CONSTU32( 0x67DE18E7 ), CONSTU32( 0x453994BA ), CONSTU32( 0xCFB11EAD ) }, 0x3F94 }, // 1e-32L
    { { CONSTU32( 0x3F2398CC ), CONSTU32( 0xA539E9A5 ), CONSTU32( 0xA87FEA27 ) }, 0x3F2A }, // 1e-64L
    { { CONSTU32( 0xAC7CB3D9 ), CONSTU32( 0x64BCE4A0 ), CONSTU32( 0xDDD0467C ) }, 0x3E55 }, // 1e-128L
    { { CONSTU32( 0xFA911122 ), CONSTU32( 0x637A1939 ), CONSTU32( 0xC0314325 ) }, 0x3CAC }, // 1e-256L
    { { CONSTU32( 0x7132D2E4 ), CONSTU32( 0xDB23D21C ), CONSTU32( 0x9049EE32 ) }, 0x395A }, // 1e-512L
    { { CONSTU32( 0x87A600A6 ), CONSTU32( 0xDA57C0BD ), CONSTU32( 0xA2A682A5 ) }, 0x32B5 }, // 1e-1024L
    { { CONSTU32( 0x4925110F ), CONSTU32( 0x34362DE4 ), CONSTU32( 0xCEAE534F ) }, 0x256B }, // 1e-2048L
    { { CONSTU32( 0x2DE37E46 ), CONSTU32( 0xD2CE9FDE ), CONSTU32( 0xA6DD04C8 ) }, 0x0AD8 }  // 1e-4096L
};
...
*/
{
    if( x->m32[2] > CONSTU32( 0x19999999 ) ) {
        return 1;
    } else if( x->m32[2] < CONSTU32( 0x19999999 ) ) {
        return -1;
    } else if( x->m32[1] > CONSTU32( 0x99999999 ) ) {
        return 1;
    } else if( x->m32[1] < CONSTU32( 0x99999999 ) ) {
        return -1;
    } else if( x->m32[0] > CONSTU32( 0x99999998 ) ) {
        return 1;
    } else if( x->m32[0] < CONSTU32( 0x99999998 ) ) {
        return -1;
    } else {
