/*
 *  sqlucode.h  Open Database Connectivity (ODBC) Unicode functions
 *
 * =========================================================================
 *
 *                          Open Watcom Project
...
#define SQL_WCHAR           (-8L)
#define SQL_WVARCHAR        (-9L)
#define SQL_WLONGVARCHAR    (-10L)
...
SQLRETURN SQL_API   SQLColAttributeA( SQLHSTMT, SQLUSMALLINT, SQLUSMALLINT, SQLPOINTER, SQLSMALLINT, SQLSMALLINT *, SQLPOINTER );
