...
/**
*
*  Name:        jtohira         ひらがなに変換
*
*  Synopsis:    nc = jtohira( c );
*
*               JMOJI nc;       変換した全角文字
*               JMOJI c;        変換する全角文字
*
...
*
*
*  Name:        jtohira         Convert to Hiragana of 2-byte KANJI code
*
*  Synopsis:    nc = jtohira( c );
*
*               JMOJI nc;       Hiragana of 2-byte KANJI code
...
_WCRTLINK unsigned int _mbctohira( unsigned int ch )
{
    return( jtohira( ch ) );
}


_WCRTLINK JMOJI jtohira( JMOJI c )
{
    if( jiskana( c ) && c <= 0x8393 )
        c -= ( c < 0x837f ) ? 0xa1 : 0xa2;
    return( c );
}
