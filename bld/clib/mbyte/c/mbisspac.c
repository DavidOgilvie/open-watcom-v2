...
/**
 * Determine if a multibyte character is a whitespace character.
 */

_WCRTLINK int _ismbcspace( unsigned int ch )
{
#ifdef __NT__
    BOOL                rc;
    int                 len;
    ...
    if( (char_type[ 0 ] & C1_SPACE) == 0 ) return( 0 );
    return( 1 );
