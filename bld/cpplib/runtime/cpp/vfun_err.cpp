...
// VFUN_ERR.CPP -- support for trapping calls to stripped virtual calls
//
// This routine should never be called, since only functions which are
// not called virtually should be stripped.
//
// 93/02/04 -- J.W.Welch    -- Defined
