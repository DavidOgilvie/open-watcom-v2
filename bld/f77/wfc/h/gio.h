...
*  ========================================================================
*
* Description:  I/O code generation routines
*
****************************************************************************/
...
extern void    GIOStruct( sym_id sd );
extern void    GIOItem( void );
extern void    GIOArray( void );
extern void    GIOStructArray( void );
extern void    GStopIO( void );
extern void    GPassValue( FCODE rtn );
extern void    GSetNameList( FCODE routine );
extern void    GPassAddr( FCODE routine );
extern void    GPassStmtNo( sym_id sn, FCODE routine );
extern void    GPassLabel( label_id label, RTCODE routine );
...
extern void    GCheckEOF( label_id label );
