/*
 *  lmerrlog.h  LAN Manager error log
 *
 * =========================================================================
 *
 *                          Open Watcom Project
...
#define NELOG_NoTransportLoaded                     (ERRLOG2_BASE + 28)
...
#define NELOG_NetlogonFailedSecretData              (ERRLOG2_BASE + 36)
...
typedef ERROR_LOG   *PERROR_LOG;
typedef ERROR_LOG   *LPERROR_LOG;

/* Functions in NETAPI32.DLL */
NET_API_STATUS NET_API_FUNCTION NetErrorLogClear( LPCWSTR, LPCWSTR, LPBYTE );
NET_API_STATUS NET_API_FUNCTION NetErrorLogRead( LPCWSTR, LPWSTR, LPHLOG, DWORD, LPDWORD, DWORD, DWORD, LPBYTE *, DWORD, LPDWORD, LPDWORD );
NET_API_STATUS NET_API_FUNCTION NetErrorLogWrite( LPBYTE, DWORD, LPCWSTR, LPBYTE, DWORD, LPBYTE, DWORD, LPBYTE );
