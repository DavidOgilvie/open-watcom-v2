...
#define __DEFARG_H__
//
// DEFARG.H -- default arguments
//
// 92/06/08 -- J.W.Welch -- defined
...
;
void DefineDefaultValues(       // MAKE DEFAULT VALUE FOR EACH DEFARG PARM
...
#else
#define DefArgPCHWrite()
#define DefArgPCHRead()
#endif
