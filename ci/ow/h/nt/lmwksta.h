/*
 *  lmwksta.h   LAN Manager workstation functions
 *
 * =========================================================================
 *
 *                          Open Watcom Project
...
#define WKSTA_MAXWORKBUF_PARMNUM                16
...
#define WKSTA_WORKHEURISTICS_PARMNUM            32
...
/* Workstation information (level 101) */
...
typedef WKSTA_INFO_101  *PWKSTA_INFO_101;
typedef WKSTA_INFO_101  *LPWKSTA_INFO_101;

/* Workstation information (level 102) */
...
typedef WKSTA_INFO_102  *PWKSTA_INFO_102;
typedef WKSTA_INFO_102  *LPWKSTA_INFO_102;

/* Workstation information (level 302) */
...
typedef WKSTA_INFO_302  *PWKSTA_INFO_302;
typedef WKSTA_INFO_302  *LPWKSTA_INFO_302;

/* Workstation information (level 402) */
...
typedef WKSTA_INFO_402  *PWKSTA_INFO_402;
typedef WKSTA_INFO_402  *LPWKSTA_INFO_402;

/* Workstation information (level 502) */
typedef struct _WKSTA_INFO_502 {
    ...
    BOOL    wki502_use_opportunistics_locking;
...
typedef WKSTA_INFO_502  *PWKSTA_INFO_502;
typedef WKSTA_INFO_502  *LPWKSTA_INFO_502;

/* Workstation information (level 1010) */
typedef struct _WKSTA_INFO_1010 {
    DWORD   wki1010_char_wait;
} WKSTA_INFO_1010;
typedef WKSTA_INFO_1010 *PWKSTA_INFO_1010;
typedef WKSTA_INFO_1010 *LPWKSTA_INFO_1010;

/* Workstation information (level 1011) */
typedef struct _WKSTA_INFO_1011 {
    DWORD   wki1011_collection_time;
} WKSTA_INFO_1011;
typedef WKSTA_INFO_1011 *PWKSTA_INFO_1011;
typedef WKSTA_INFO_1011 *LPWKSTA_INFO_1011;

/* Workstation information (level 1012) */
typedef struct _WKSTA_INFO_1012 {
    DWORD   wki1012_maximum_collection_count;
} WKSTA_INFO_1012;
typedef WKSTA_INFO_1012 *PWKSTA_INFO_1012;
typedef WKSTA_INFO_1012 *LPWKSTA_INFO_1012;

/* Workstation information (level 1013) */
typedef struct _WKSTA_INFO_1013 {
    DWORD   wki1013_keep_conn;
} WKSTA_INFO_1013;
typedef WKSTA_INFO_1013 *PWKSTA_INFO_1013;
typedef WKSTA_INFO_1013 *LPWKSTA_INFO_1013;

/* Workstation information (level 1018) */
typedef struct _WKSTA_INFO_1018 {
    DWORD   wki1018_sess_timeout;
} WKSTA_INFO_1018;
typedef WKSTA_INFO_1018 *PWKSTA_INFO_1018;
typedef WKSTA_INFO_1018 *LPWKSTA_INFO_1018;

/* Workstation information (level 1023) */
typedef struct _WKSTA_INFO_1023 {
    DWORD   wki1023_siz_char_buf;
} WKSTA_INFO_1023;
typedef WKSTA_INFO_1023 *PWKSTA_INFO_1023;
typedef WKSTA_INFO_1023 *LPWKSTA_INFO_1023;

/* Workstation information (level 1027) */
typedef struct _WKSTA_INFO_1027 {
    DWORD   wki1027_errlog_sz;
} WKSTA_INFO_1027;
typedef WKSTA_INFO_1027 *PWKSTA_INFO_1027;
typedef WKSTA_INFO_1027 *LPWKSTA_INFO_1027;

/* Workstation information (level 1028) */
typedef struct _WKSTA_INFO_1028 {
    DWORD   wki1028_print_buf_time;
} WKSTA_INFO_1028;
typedef WKSTA_INFO_1028 *PWKSTA_INFO_1028;
typedef WKSTA_INFO_1028 *LPWKSTA_INFO_1028;

/* Workstation information (level 1032) */
typedef struct _WKSTA_INFO_1032 {
    DWORD wki1032_wrk_heuristics;
} WKSTA_INFO_1032;
typedef WKSTA_INFO_1032 *PWKSTA_INFO_1032;
typedef WKSTA_INFO_1032 *LPWKSTA_INFO_1032;

/* Workstation information (level 1033) */
typedef struct _WKSTA_INFO_1033 {
    DWORD   wki1033_max_threads;
} WKSTA_INFO_1033;
typedef WKSTA_INFO_1033 *PWKSTA_INFO_1033;
typedef WKSTA_INFO_1033 *LPWKSTA_INFO_1033;

/* Workstation information (level 1041) */
typedef struct _WKSTA_INFO_1041 {
    DWORD   wki1041_lock_quota;
} WKSTA_INFO_1041;
typedef WKSTA_INFO_1041 *PWKSTA_INFO_1041;
typedef WKSTA_INFO_1041 *LPWKSTA_INFO_1041;

/* Workstation information (level 1042) */
typedef struct _WKSTA_INFO_1042 {
    DWORD   wki1042_lock_increment;
} WKSTA_INFO_1042;
typedef WKSTA_INFO_1042 *PWKSTA_INFO_1042;
typedef WKSTA_INFO_1042 *LPWKSTA_INFO_1042;

/* Workstation information (level 1043) */
typedef struct _WKSTA_INFO_1043 {
    DWORD   wki1043_lock_maximum;
} WKSTA_INFO_1043;
typedef WKSTA_INFO_1043 *PWKSTA_INFO_1043;
typedef WKSTA_INFO_1043 *LPWKSTA_INFO_1043;

/* Workstation information (level 1044) */
typedef struct _WKSTA_INFO_1044 {
    DWORD   wki1044_pipe_increment;
} WKSTA_INFO_1044;
typedef WKSTA_INFO_1044 *PWKSTA_INFO_1044;
typedef WKSTA_INFO_1044 *LPWKSTA_INFO_1044;

/* Workstation information (level 1045) */
typedef struct _WKSTA_INFO_1045 {
    DWORD   wki1045_pipe_maximum;
} WKSTA_INFO_1045;
typedef WKSTA_INFO_1045 *PWKSTA_INFO_1045;
typedef WKSTA_INFO_1045 *LPWKSTA_INFO_1045;

/* Workstation information (level 1046) */
typedef struct _WKSTA_INFO_1046 {
    DWORD   wki1046_dormant_file_limit;
} WKSTA_INFO_1046;
typedef WKSTA_INFO_1046 *PWKSTA_INFO_1046;
typedef WKSTA_INFO_1046 *LPWKSTA_INFO_1046;

/* Workstation information (level 1047) */
typedef struct _WKSTA_INFO_1047 {
    DWORD   wki1047_cache_file_timeout;
} WKSTA_INFO_1047;
typedef WKSTA_INFO_1047 *PWKSTA_INFO_1047;
typedef WKSTA_INFO_1047 *LPWKSTA_INFO_1047;

/* Workstation information (level 1048) */
typedef struct _WKSTA_INFO_1048 {
    BOOL    wki1048_use_opportunistic_locking;
} WKSTA_INFO_1048;
typedef WKSTA_INFO_1048 *PWKSTA_INFO_1048;
typedef WKSTA_INFO_1048 *LPWKSTA_INFO_1048;

/* Workstation information (level 1049) */
typedef struct _WKSTA_INFO_1049 {
    BOOL    wki1049_use_unlock_behind;
} WKSTA_INFO_1049;
typedef WKSTA_INFO_1049 *PWKSTA_INFO_1049;
typedef WKSTA_INFO_1049 *LPWKSTA_INFO_1049;

/* Workstation information (level 1050) */
typedef struct _WKSTA_INFO_1050 {
    BOOL    wki1050_use_close_behind;
} WKSTA_INFO_1050;
typedef WKSTA_INFO_1050 *PWKSTA_INFO_1050;
typedef WKSTA_INFO_1050 *LPWKSTA_INFO_1050;

/* Workstation information (level 1051) */
typedef struct _WKSTA_INFO_1051 {
    BOOL    wki1051_buf_named_pipes;
} WKSTA_INFO_1051;
typedef WKSTA_INFO_1051 *PWKSTA_INFO_1051;
typedef WKSTA_INFO_1051 *LPWKSTA_INFO_1051;

/* Workstation information (level 1052) */
typedef struct _WKSTA_INFO_1052 {
    BOOL    wki1052_use_lock_read_unlock;
} WKSTA_INFO_1052;
typedef WKSTA_INFO_1052 *PWKSTA_INFO_1052;
typedef WKSTA_INFO_1052 *LPWKSTA_INFO_1052;

/* Workstation information (level 1053) */
typedef struct _WKSTA_INFO_1053 {
    BOOL    wki1053_utilize_nt_caching;
} WKSTA_INFO_1053;
typedef WKSTA_INFO_1053 *PWKSTA_INFO_1053;
typedef WKSTA_INFO_1053 *LPWKSTA_INFO_1053;

/* Workstation information (level 1054) */
typedef struct _WKSTA_INFO_1054 {
    BOOL    wki1054_use_raw_read;
} WKSTA_INFO_1054;
typedef WKSTA_INFO_1054 *PWKSTA_INFO_1054;
typedef WKSTA_INFO_1054 *LPWKSTA_INFO_1054;

/* Workstation information (level 1055) */
typedef struct _WKSTA_INFO_1055 {
    BOOL    wki1055_use_raw_write;
} WKSTA_INFO_1055;
typedef WKSTA_INFO_1055 *PWKSTA_INFO_1055;
typedef WKSTA_INFO_1055 *LPWKSTA_INFO_1055;

/* Workstation information (level 1056) */
typedef struct _WKSTA_INFO_1056 {
    BOOL    wki1056_use_raw_write_data;
} WKSTA_INFO_1056;
typedef WKSTA_INFO_1056 *PWKSTA_INFO_1056;
typedef WKSTA_INFO_1056 *LPWKSTA_INFO_1056;

/* Workstation information (level 1057) */
typedef struct _WKSTA_INFO_1057 {
    BOOL    wki1057_use_encryption;
} WKSTA_INFO_1057;
typedef WKSTA_INFO_1057 *PWKSTA_INFO_1057;
typedef WKSTA_INFO_1057 *LPWKSTA_INFO_1057;

/* Workstation information (level 1058) */
typedef struct _WKSTA_INFO_1058 {
    BOOL    wki1058_buf_files_deny_write;
} WKSTA_INFO_1058;
typedef WKSTA_INFO_1058 *PWKSTA_INFO_1058;
typedef WKSTA_INFO_1058 *LPWKSTA_INFO_1058;

/* Workstation information (level 1059) */
typedef struct _WKSTA_INFO_1059 {
    BOOL    wki1059_buf_read_only_files;
} WKSTA_INFO_1059;
typedef WKSTA_INFO_1059 *PWKSTA_INFO_1059;
typedef WKSTA_INFO_1059 *LPWKSTA_INFO_1059;

/* Workstation information (level 1060) */
typedef struct _WKSTA_INFO_1060 {
    BOOL    wki1060_force_core_create_mode;
} WKSTA_INFO_1060;
typedef WKSTA_INFO_1060 *PWKSTA_INFO_1060;
typedef WKSTA_INFO_1060 *LPWKSTA_INFO_1060;

/* Workstation information (level 1061) */
typedef struct _WKSTA_INFO_1061 {
    BOOL    wki1061_use_512_byte_max_transfer;
} WKSTA_INFO_1061;
typedef WKSTA_INFO_1061 *PWKSTA_INFO_1061;
typedef WKSTA_INFO_1061 *LPWKSTA_INFO_1061;

/* Workstation information (level 1062) */
typedef struct _WKSTA_INFO_1062 {
    DWORD   wki1062_read_ahead_throughput;
} WKSTA_INFO_1062;
typedef WKSTA_INFO_1062 *PWKSTA_INFO_1062;
typedef WKSTA_INFO_1062 *LPWKSTA_INFO_1062;

/* Workstation user information (level 0) */
typedef struct _WKSTA_USER_INFO_0 {
    LMSTR   wkui0_username;
} WKSTA_USER_INFO_0;
typedef WKSTA_USER_INFO_0   *PWKSTA_USER_INFO_0;
typedef WKSTA_USER_INFO_0   *LPWKSTA_USER_INFO_0;

/* Workstation user information (level 1) */
...
typedef WKSTA_USER_INFO_1   *PWKSTA_USER_INFO_1;
typedef WKSTA_USER_INFO_1   *LPWKSTA_USER_INFO_1;

/* Workstation user information (level 1101) */
typedef struct _WKSTA_USER_INFO_1101 {
    LMSTR   wkui1101_oth_domains;
} WKSTA_USER_INFO_1101;
typedef WKSTA_USER_INFO_1101    *PWKSTA_USER_INFO_1101;
typedef WKSTA_USER_INFO_1101    *LPWKSTA_USER_INFO_1101;

/* Workstation transport information (level 0) */
...
typedef WKSTA_TRANSPORT_INFO_0  *PWKSTA_TRANSPORT_INFO_0;
typedef WKSTA_TRANSPORT_INFO_0  *LPWKSTA_TRANSPORT_INFO_0;

/* Functions in NETAPI32.DLL */
NET_API_STATUS NET_API_FUNCTION NetWkstaGetInfo( LMSTR, DWORD, LPBYTE * );
NET_API_STATUS NET_API_FUNCTION NetWkstaSetInfo( LMSTR, DWORD, LPBYTE, LPDWORD );
NET_API_STATUS NET_API_FUNCTION NetWkstaTransportAdd( LMSTR, DWORD, LPBYTE, DWORD );
NET_API_STATUS NET_API_FUNCTION NetWkstaTransportDel( LMSTR, LMSTR, DWORD );
NET_API_STATUS NET_API_FUNCTION NetWkstaTransportEnum( LMSTR, DWORD, LPBYTE *, DWORD, DWORD, LPDWORD, LPDWORD );
NET_API_STATUS NET_API_FUNCTION NetWkstaUserEnum( LMSTR, DWORD, LPBYTE *, DWORD, LPDWORD, LPDWORD, LPDWORD );
NET_API_STATUS NET_API_FUNCTION NetWkstaUserGetInfo( LMSTR, DWORD, LPBYTE * );
NET_API_STATUS NET_API_FUNCTION NetWkstaUserSetInfo( LMSTR, DWORD, LPBYTE, LPDWORD );
