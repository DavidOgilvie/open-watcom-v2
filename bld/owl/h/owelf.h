...
typedef struct elf_special_section {
    owl_string_handle   name;
    owl_offset          length;
    char                *buffer;
} elf_special_section;

typedef struct elf_file_info {
    elf_special_section string_table;
    elf_special_section symbol_table;
    owl_offset          next_section;           // starting offset of next section to be placed
} elf_file_info;
