...
extern char     *CopySourceLine( cue_handle *cueh );
extern bool     GetBPSymAddr( brkp *bp, address *addr );
extern void     SetPointAddr( brkp *bp, address addr );
extern bool     BrkCheckWatchLimit( address loc, mad_type_handle mth );
...
extern bool     FindFirstCue( mod_handle mod, cue_handle *cueh );
