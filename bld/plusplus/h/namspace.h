...
extern void NameSpaceUnnamed( TOKEN_LOCN * );
extern void NameSpaceNamed( PTREE );
extern void NameSpaceAlias( PTREE, PTREE );
extern void NameSpaceUsingDirective( PTREE );
