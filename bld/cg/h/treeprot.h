...
extern tn           TGNode( tn_class class, cg_op op, tn left, tn rite, type_def *tipe );
...
extern call_handle  TGInitCall( tn left, type_def *tipe, cg_sym_handle sym );
extern tn           TGAddParm( call_handle call, tn parm, type_def *tipe );
...
extern tn           DoTGPreGets( cg_op op, tn left, tn rite, type_def *tipe, tn_class class, tn_class assn_class );
