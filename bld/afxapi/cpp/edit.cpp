...
*  ========================================================================
*
* Description:  Implementation of CEdit.
*
****************************************************************************/
...
{
    WCHAR szBuffer[1024];
    ::SendMessage( m_hWnd, EM_GETCUEBANNER, (WPARAM)szBuffer, 1024 );
    return( CString( szBuffer ) );
}

BOOL CEdit::ShowBalloonTip( LPCWSTR lpszTitle, LPCWSTR lpszText, INT ttiIcon )
/****************************************************************************/
{
    EDITBALLOONTIP ebt;
    ebt.cbStruct = sizeof( EDITBALLOONTIP );
    ebt.pszTitle = lpszTitle;
    ebt.pszText = lpszText;
    ebt.ttiIcon = ttiIcon;
    return( (BOOL)::SendMessage( m_hWnd, EM_SHOWBALLOONTIP, 0, (LPARAM)&ebt ) );
}
