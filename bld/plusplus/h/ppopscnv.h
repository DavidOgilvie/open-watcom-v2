...
// UNARY OPERATORS
//
{   OPBASIC( BOOL,        __x__,       OPM_B  | OPM_I  | OPM_A        )
,   OPBASIC( CHAR,        __x__,       OPM_I  | OPM_A                 )
,   OPBASIC( SCHAR,       __x__,       OPM_I  | OPM_A                 )
,   OPBASIC( UCHAR,       __x__,       OPM_I  | OPM_A                 )
,   OPBASIC( WCHAR,       __x__,       OPM_I  | OPM_A                 )
,   OPBASIC( SSHORT,      __x__,       OPM_I  | OPM_A                 )
,   OPBASIC( USHORT,      __x__,       OPM_I  | OPM_A                 )
,   OPBASIC( SINT,        __x__,       OPM_I  | OPM_A                 )
,   OPBASIC( UINT,        __x__,       OPM_I  | OPM_A                 )
,   OPBASIC( SLONG,       __x__,       OPM_I  | OPM_A                 )
,   OPBASIC( ULONG,       __x__,       OPM_I  | OPM_A                 )
,   OPBASIC( SLONG64,     __x__,       OPM_I  | OPM_A                 )
,   OPBASIC( ULONG64,     __x__,       OPM_I  | OPM_A                 )
,   OPBASIC( FLOAT,       __x__,       OPM_A                          )
,   OPBASIC( DOUBLE,      __x__,       OPM_A                          )
,   OPBASIC( LONG_DOUBLE, __x__,       OPM_A                          )
,   OPBASIC( POINTER,     __x__,       OPM_P  | OPM_A                 )
//
// BINARY OPERATORS
//
...
,   OPBASIC( __x__,       __x__,       OPM_RR                         )
,   OPBASIC( __x__,       __x__,       0                              )
}
#undef __x__
#endif
