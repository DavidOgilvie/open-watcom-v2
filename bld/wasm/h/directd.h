...
pick( TOK_LANG_NOLANG,   "NOLANGUAGE",   WASM_LANG_NONE,     0               ),
pick( TOK_LANG_BASIC,    "BASIC",        WASM_LANG_BASIC,    0               ),
pick( TOK_LANG_FORTRAN,  "FORTRAN",      WASM_LANG_FORTRAN,  0               ),
pick( TOK_LANG_PASCAL,   "PASCAL",       WASM_LANG_PASCAL,   0               ),
pick( TOK_LANG_C,        "C",            WASM_LANG_C,        0               ),
pick( TOK_LANG_WATCOM_C, "WATCOM_C",     WASM_LANG_WATCOM_C, 0               ),
pick( TOK_LANG_STDCALL,  "STDCALL",      WASM_LANG_STDCALL,  0               ),
pick( TOK_LANG_SYSCALL,  "SYSCALL",      WASM_LANG_SYSCALL,  0               ),
