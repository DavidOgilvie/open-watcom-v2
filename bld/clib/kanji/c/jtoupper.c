...
/**
*
*  Name:        jtoupper        大文字に変換
*
*  Synopsis:    nc = jtoupper( c );
*
*               JMOJI nc;       変換した全角文字
*               JMOJI c;        変換する全角文字
*
...
*
*
*  Name:        jtoupper        Convert to upper case 2-byte KANJI code
*
*  Synopsis:    nc = jtoupper( c );
*
*               JMOJI nc;       Upper case 2-byte KANJI code
...
_WCRTLINK JMOJI jtoupper( JMOJI c )
{
    return( jislower( c ) ? ( c - 0x21 ) : c );
}
