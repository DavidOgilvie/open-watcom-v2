/*
 *  lmstats.h   LAN Manager statistics functions
 *
 * =========================================================================
 *
 *                          Open Watcom Project
...
/* Workstation statistics (level 0) */
...
#endif
typedef STAT_WORKSTATION_0  *PSTAT_WORKSTATION_0;
typedef STAT_WORKSTATION_0  *LPSTAT_WORKSTATION_0;
...
typedef STAT_SERVER_0   *PSTAT_SERVER_0;
typedef STAT_SERVER_0   *LPSTAT_SERVER_0;

/* Functions in NETAPI32.DLL */
NET_API_STATUS NET_API_FUNCTION NetStatisticsGet( LPTSTR, LPTSTR, DWORD, DWORD, LPBYTE * );
