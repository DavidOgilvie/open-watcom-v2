...
// This enum allows the debugger to indicate what window message
// a callback routine is receiving if you do a 
// WINDOW_MSG _msg= msg;
// at the beginning of the callback routine.
typedef enum {
	_WM_NULL=0,									// 0x0000
	_WM_CREATE,									// 0x0001
	_WM_DESTROY,								// 0x0002
	...
	_WM_SETTINGCHANGE_OR_WM_WININICHANGE=0x001A,// 0x001A
	...
	_WM_MSG_OxO4C,								// 0x004C
	_WM_MSG_OxO4D,								// 0x004D
	_WM_NOTIFY,									// 0x004E
	_WM_MSG_OxO4F,								// 0x004F
	...
	_WM_MSG_0x0AA,								// 0x00AA
	_WM_NCXBUTTONDOWN,							// 0x00AB
	_WM_NCXBUTTONUP,							// 0x00AC
	_WM_NCXBUTTONDBLCLK,						// 0x00AD
	_WM_INPUT_DEVICE_CHANGE=0x00FE,				// 0x00FE
	_WM_INPUT,									// 0x00FF
	_WM_KEYFIRST_OR_WM_KEYDOWN,					// 0x0100
//	_WM_KEYFIRST,								// 0x0100
//	_WM_KEYDOWN,								// 0x0100
	_WM_KEYUP,									// 0x0101
	_WM_CHAR,									// 0x0102
	...
	_WM_KEYLAST,								// 0x0108
	_WM_UNICHAR_OR_WM_KEYLAST,					// 0x0109
//	_WM_UNICHAR,								// 0x0109
//	_WM_KEYLAST,								// 0x0109
	_WM_IME_STARTCOMPOSITION=0x010D,			// 0x010D
	_WM_IME_ENDCOMPOSITION,						// 0x010E
	_WM_IME_COMPOSITION_OR_WM_IME_KEYLAST,		// 0x010F
...
//	_WM_IME_KEYLAST,							// 0x010F
	...
	_WM_MOUSEFIRST_OR_WM_MOUSEMOVE=0x0200,		// 0x0200
...
//	_WM_MOUSEMOVE,								// 0x0200
	...
	_WM_MBUTTONDBLCLK_OR_WM_MOUSELAST,			// 0x0209
//	_WM_MBUTTONDBLCLK,							// 0x0209
//	_WM_MOUSELAST,								// 0x0209
	_WM_MOUSEWHEEL,								// 0x020A
	_WM_XBUTTONDOWN,							// 0x020B
	_WM_XBUTTONUP,								// 0x020C
	_WM_XBUTTONDBLCLK_OR_WM_MOUSELAST,			// 0x020D
//	_WM_XBUTTONDBLCLK,							// 0x020D
//	_WM_MOUSELAST,								// 0x020D
	_WM_MOUSEHWHEEL_OR_WM_MOUSELAST,			// 0x020E
//	_WM_MOUSEHWHEEL,							// 0x020E
//	_WM_MOUSELAST,								// 0x020E
	...
	_WM_DWMWINDOWMAXIMIZEDCHANGE,				// 0x0321
