...
#ifndef mc2switch_class
#define mc2switch_class

#include "mswitch.hpp"

WCLASS MC2Switch : public MSwitch
{
        Declare( MC2Switch )
        public:
                MC2Switch( const char* name=NULL ) : MSwitch( name ) {}
                MC2Switch( WTokenFile& fil, WString& tok );
                ~MC2Switch() {}
