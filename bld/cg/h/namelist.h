...
extern name             *AllocTemp( type_class_def type_class );
extern name             *TempOffset( name *temp, type_length offset, type_class_def type_class );
extern name             *SAllocUserTemp( pointer symbol, type_class_def type_class, type_length size );
extern name             *AllocUserTemp( pointer symbol, type_class_def type_class );
extern name             *DeAlias( name *temp );
extern name             *AllocRegName( hw_reg_set regs );
extern name             *ScaleIndex( name *index, name *base, type_length offset, type_class_def type_class, type_length size, scale_typ scale, i_flags flags );
extern name             *SAllocIndex( name *index, name *base, type_length offset, type_class_def type_class, type_length size );
extern name             *AllocIndex( name *index, name *base, type_length offset, type_class_def type_class );
