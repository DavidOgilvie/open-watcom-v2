...
extern dip_status       FindTypeHandle( imp_image_handle *, imp_mod_handle, unsigned index, imp_type_handle *ith );
extern search_result    LookupTypeName( imp_image_handle *, imp_mod_handle, lookup_item *li, imp_type_handle *ith );
extern search_result    SearchEnumName( imp_image_handle *, imp_mod_handle, lookup_item *li, void *d );
extern search_result    SearchTypeName( imp_image_handle *, imp_mod_handle, lookup_item *li, void *d );
extern unsigned         SymHdl2CstName( imp_image_handle *, imp_sym_handle *, char *buff, unsigned buff_size );
extern unsigned         SymHdl2TypName( imp_image_handle *, imp_sym_handle *, char *buff, unsigned buff_size );
extern unsigned         SymHdl2MbrName( imp_image_handle *, imp_sym_handle *, char *buff, unsigned buff_size );
extern dip_status       SymHdl2CstValue( imp_image_handle *, imp_sym_handle *, void *d );
extern dip_status       SymHdl2CstType( imp_image_handle *, imp_sym_handle *, imp_type_handle *ith );
extern dip_status       SymHdl2TypType( imp_image_handle *, imp_sym_handle *, imp_type_handle *ith );
extern dip_status       SymHdl2MbrType( imp_image_handle *, imp_sym_handle *, imp_type_handle *ith );
extern dip_status       SymHdl2MbrLoc( imp_image_handle *, imp_sym_handle *, location_context *lc, location_list *ll );
extern dip_status       SymHdl2MbrInfo( imp_image_handle *, imp_sym_handle *, sym_info *si, location_context *lc );
...
extern const char       *FindSpecCueTable( imp_image_handle *, imp_mod_handle, const char **base );
